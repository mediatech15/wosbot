package dev.fidgetcode.bot.common.view;
...
import dev.fidgetcode.bot.console.enumerable.PrioritizableItem;
import dev.fidgetcode.bot.ot.DTOPriorityItem;
...
public abstract class AbstractProfileController implements IProfileLoadListener, IProfileObserverInjectable {
	...
	private void updateProfile(TextField textField, EnumConfigurationKey configKey) {
		...
		} else if (configKey.getType() == LocalDateTime.class) {
