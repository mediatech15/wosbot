package dev.fidgetcode.bot.profile.controller;
...
import dev.fidgetcode.bot.launcher.view.ILauncherConstants;
...
import dev.fidgetcode.bot.profile.model.IProfileModel;
import dev.fidgetcode.bot.profile.model.ProfileAux;
import dev.fidgetcode.bot.profile.model.impl.ProfileCallback;
import dev.fidgetcode.bot.profile.model.impl.ProfileModel;
import dev.fidgetcode.bot.profile.view.BulkUpdateDialogController;
import dev.fidgetcode.bot.profile.view.EditProfileController;
import dev.fidgetcode.bot.profile.view.NewProfileLayoutController;
...
public class ProfileManagerActionController implements IProfileStatusChangeListener {
	...
	public void showBulkUpdateDialog(Long loadedProfileId, List<ProfileAux> profiles, javafx.scene.Node ownerNode) {
		...
		try {
			...
			FXMLLoader loader = new FXMLLoader(
				getClass().getResource("/dev/fidgetcode/bot/profile/view/BulkUpdateDialog.fxml")
			);
			Parent root = loader.load();
	...
	public void showEditProfileDialog(ProfileAux profile, javafx.scene.Node ownerNode) {
		...
		try {
			...
			FXMLLoader loader = new FXMLLoader(
				getClass().getResource("/dev/fidgetcode/bot/profile/view/EditProfile.fxml")
			);
			Parent root = loader.load();
