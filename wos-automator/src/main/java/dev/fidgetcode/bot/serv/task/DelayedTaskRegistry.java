...
import dev.fidgetcode.bot.serv.task.impl.*;
...
public class DelayedTaskRegistry {
    ...
    static {
        ...
        // Chief Order tasks
        registry.put(TpDailyTaskEnum.CHIEF_ORDER_RUSH_JOB, profile -> new ChiefOrderTask(profile, TpDailyTaskEnum.CHIEF_ORDER_RUSH_JOB, ChiefOrderTask.ChiefOrderType.RUSH_JOB));
        registry.put(TpDailyTaskEnum.CHIEF_ORDER_URGENT_MOBILIZATION, profile -> new ChiefOrderTask(profile, TpDailyTaskEnum.CHIEF_ORDER_URGENT_MOBILIZATION, ChiefOrderTask.ChiefOrderType.URGENT_MOBILIZATION));
        registry.put(TpDailyTaskEnum.CHIEF_ORDER_PRODUCTIVITY_DAY, profile -> new ChiefOrderTask(profile, TpDailyTaskEnum.CHIEF_ORDER_PRODUCTIVITY_DAY, ChiefOrderTask.ChiefOrderType.PRODUCTIVITY_DAY));
