...
import dev.fidgetcode.bot.utilities.UtilRally;
import dev.fidgetcode.bot.utilities.number.NumberConverters;
import dev.fidgetcode.bot.utilities.number.NumberValidators;
import dev.fidgetcode.bot.utilities.ocr.TextRecognitionRetrier;
...
import dev.fidgetcode.bot.serv.ocr.BotTextRecognitionProvider;
import dev.fidgetcode.bot.serv.task.*;
import dev.fidgetcode.bot.serv.task.helper.BearTrapHelper;
import dev.fidgetcode.bot.serv.task.helper.TemplateSearchHelper.SearchConfig;
...
import static dev.fidgetcode.bot.console.enumerable.EnumConfigurationKey.*;
import static dev.fidgetcode.bot.console.enumerable.EnumTemplates.*;
...
public class BearTrapTask extends DelayedTask {
    ...
    private void tryStartOwnRally(long secondsRemaining) {
        ...
        } catch (dev.fidgetcode.bot.ex.ADBConnectionException e) {
